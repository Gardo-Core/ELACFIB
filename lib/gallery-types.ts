 ...
 * - src: Google Drive URL for the media file
 * - title: User-editable title shown in gallery and lightbox
 * - order: Explicit ordering for database storage (not array index)
 * - type: Distinguishes images from videos for rendering logic
 * - thumbnail: Optional preview image URL for videos (auto-generated by Google Drive)
 */
export interface GalleryPhoto {
  /** Unique identifier - used for React keys and dnd-kit */
  id: string
  /** Google Drive media URL */
  src: string
  /** User-editable media title */
  title: string
  /** Explicit sort order (0-based) */
  order: number
  /** Media type - 'image' or 'video' (defaults to 'image' if not specified) */
  type?: GalleryMediaType
  /** Thumbnail URL for video preview in the gallery grid */
  thumbnail?: string
}
